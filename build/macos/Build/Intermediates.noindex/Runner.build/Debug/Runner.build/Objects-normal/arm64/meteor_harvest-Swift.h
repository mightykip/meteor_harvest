...
#ifndef METEOR_HARVEST_SWIFT_H
#define METEOR_HARVEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="meteor_harvest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC14meteor_harvest11AppDelegate")
...
SWIFT_CLASS("_TtC14meteor_harvest17MainFlutterWindow")
